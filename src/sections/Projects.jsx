...
function Projects() {
  return (
    ...
    <img  className='hover:blur-sm w-[100%]' src="https://media.discordapp.net/attachments/942157875323748363/1092553981512929311/Screenshot_2023-03-29_160931.png?width=960&height=483" alt="" />
      <h1>
        Forum 
      </h1>
